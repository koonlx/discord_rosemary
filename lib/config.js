...
const PINNED_BUTTONS = [
  { label: '파티사냥', customId: 'party-hunting', kind: 0 },
  { label: '소환서', customId: 'summon-scroll', kind: 1 },
  { label: '아토락시온', customId: 'atoraxxion', kind: 2 },
  { label: '검은사당', customId: 'black-shrine', kind: 3 },
  { label: '항해', customId: 'sailing', kind: 4 },
  { label: '그랑프리', customId: 'grand-prix', kind: 5 },
];
