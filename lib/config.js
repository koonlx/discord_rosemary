...
const PINNED_BUTTONS = [
  { label: '파티사냥', customId: 'party-hunting' },
  { label: '소환서', customId: 'summon-scroll' },
  { label: '아토락시온', customId: 'atoraxxion' },
  { label: '검은사당', customId: 'black-shrine' },
  { label: '항해', customId: 'sailing' },
  { label: '그랑프리', customId: 'grand-prix' },
];
